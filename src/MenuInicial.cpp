...
MenuInicial::MenuInicial() : etapa(0), nJogadores(1), fase(2) {
    
    nomeJogo.setFillColor(sf::Color::Yellow);

    nomeJogo.setFont(fonte);
    nomeJogo.setString("BugHunter");
    nomeJogo.setCharacterSize(60);
    nomeJogo.setFillColor(sf::Color::Blue);
...
int MenuInicial::mostrar(sf::RenderWindow& window) {
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(ev)) {
            window.clear(sf::Color(100, 50, 50)); 
        ...
        if (etapa == 0) {
            ...
            instrucoes.setString("Enter para jogar | Esc para voltar");
