...
void Gerenciador_Colisoes::tratarColisoesJogsObstacs()
{
    ...
    pJog1->setChao(false); //vai dar true na fun�ao obstaculizar se estiver pisando em obstaculo.
    for(it = LOs.begin(); it != LOs.end(); it++)
    {
        ...
        {
            pObst->obstaculizar(pJog1); //tratar em obstaculizar os obstaculos de dano tamb�m. obstaculizar deve 
